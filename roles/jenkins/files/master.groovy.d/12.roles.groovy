...
Method assignRoleMethod = RoleBasedAuthorizationStrategy.class.getDeclaredMethod("doAssignRole", String.class, String.class, String.class);
...
strategy.doAssignRole(RoleBasedAuthorizationStrategy.GLOBAL, adminRole, adminUser);
strategy.doAssignRole(RoleBasedAuthorizationStrategy.GLOBAL, authenticatedRole, globalRoleRead);
